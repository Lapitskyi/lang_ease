...
const Page: FC = (): ReactElement => {
  ...
  return (
    <div className='flex flex-col justify-center items-center w-full h-full mx-auto '>
      ...
      <div
        className='flex flex-col items-start gap-3 sm:gap-6 shadow-md w-full max-w-[500px] p-4 sm:p-8 bg-white  border border-silver rounded-xl'>
        ...
        <CustomInput label='Email' val={email} error={error} onChange={(v) => handleChange(v)}/>
        <CustomInput label='Password' type='password' val={password} error={error}
